...
object Instructions {
  ...
  //VFADD
  def VFADD              = BitPat("b1000000??????????1???????1010111")
  def VFMUL              = BitPat("b1000110??????????1???????1010111")
  def VFMIN              = BitPat("b1000100??????????101?????1010111")
  def VFMAX              = BitPat("b1000011??????????101?????1010111")
  def VFMADD             = BitPat("b?????01??????????0???????1101011")
  def VFREDSUM           = BitPat("b000000000000?????100?????1011011")
  def VBCASTX            = BitPat("b000000000100?????100?????1011011")
  def VSPLAT             = BitPat("b1011010??????????1???????1100111")
  //VFADD
  ...
  //zazad begins
  def VLSD_S              = BitPat("b?????00??????????100?????0001011") //m=00 vector_scalar
  def VLSD_V              = BitPat("b?????00??????????101?????0001011") //m=01 vector_vector
  def VSSD_S              = BitPat("b?????10??????????100?????0001011") //m=00 vector_scalar
  def VSSD_V              = BitPat("b?????10??????????101?????0001011") //m=01 vector_vector
  def VSSD_V_V10          = BitPat("b?????10??????????110?????0001011") //m=10 v1[0] == 0 ? vector_vector : vector_scalar
  def VSSD_V_V11          = BitPat("b?????10??????????111?????0001011") //m=11 v1[0] == 1 ? vector_vector : vector_scalar
  def VLXD                = BitPat("b?????01??????????1???????0001011")
  def VSXD                = BitPat("b?????11??????????1???????0001011")
  //zazad ends
